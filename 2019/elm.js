...
var $author$project$Main$init = F2(
	function (flags, options) {
		return $author$project$Ports$print('nope, there is nothing going on for now... don\'t despair it will be here shortly');
	});
...
var $author$project$Main$FuelConsumption = {$: 'FuelConsumption'};
...
var $author$project$Main$programConfig = A2(
	...
	A2(
		...
		A2($dillonkearns$elm_cli_options_parser$Cli$OptionsParser$buildSubCommand, 'fuel-consumption', $author$project$Main$FuelConsumption)),
...
var $author$project$Main$main = $dillonkearns$elm_cli_options_parser$Cli$Program$stateless(
	{config: $author$project$Main$programConfig, init: $author$project$Main$init, printAndExitFailure: $author$project$Ports$printAndExitFailure, printAndExitSuccess: $author$project$Ports$printAndExitSuccess});
