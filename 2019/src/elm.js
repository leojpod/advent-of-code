...
var $author$project$Main$init = F2(
	function (_v0, options) {
		var input = options.a;
		return $author$project$Dec01$FuelConsumption$calculator(input);
	});
...
var $author$project$Main$FuelConsumption = function (a) {
	return {$: 'FuelConsumption', a: a};
};
	...
	A2(
		...
		A2(
			...
			$elm$core$List$map(
				A2(
					...
					$elm$core$Result$fromMaybe('This is not a valid weight'))),
		...
		A2(
			...
			A2(
				...
				'needs at least one module to be given',
